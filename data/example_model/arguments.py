...
def get_args():
    ...
    parser.add_argument(
        '--output_dir', type=str, default='crowd_nav/data/dammy')
    ...
    # for haonan: 64, for shuijing: 12
    parser.add_argument(
        '--num-processes',
        type=int,
        default=12,
        help='how many training CPU processes to use (default: 16)')
    # for haonan: 64; for shuijing: 2
    parser.add_argument(
        '--num-mini-batch',
        type=int,
        default=2,
    ...
    # LSTM or GRU (results should be similar, but GRU is faster)
    parser.add_argument(
        '--recurrent-type',
        default='GRU',
        help='type of RNN')
